...
title: Hello, world!
excerpt: >-
  Hey there! Welcome to my  blog. My name is Justin, and this is my developer
  playground. Here I aim to write about my experiences as a software developer.
published: true
...
custom technologies - which host Google's top clients and guests. We have built
Experience Centers all over the world, including the Google Partner Plex in
[Tokyo](https://partnerplex.withgoogle.com/intl/ALL_jp/tokyo/#intro),
[São Paulo](https://partnerplex.withgoogle.com/intl/pt-BR_br/saopaulo/) and
Mountain View. You can also search online to
[find](https://www.practicecreative.com/work/google/)
[a](https://thinkwellgroup.com/project/google-the-grove-experience-center/)
[few](https://www.siliconrepublic.com/business/google-to-open-the-foundry-a-new-innovation-centre-in-dublin)
...
There is also so much inspiring developer content out there also. I've been
reading other developer blogs, like
[Flavio Copes](https://flaviocopes.com/developer-blog/) (and his
[_How to Start a Blog_ ebook](https://www.freecodecamp.org/news/how-to-start-a-blog-book/))
and
[Josh Comeau](https://www.joshwcomeau.com/blog/how-i-built-my-blog/), as well as
consuming some motivational content, like
[Ali Abdaal](https://youtu.be/vyVpRiqOvt4)'s YouTube videos.

Suffice to say, I'm feeling pretty inspired when it comes to starting my writing
journey 😼

As I started developing this blog, I was coming up with different "personal
brand" ideas and tried drawing different logo types for them. Now, I'm no
artist, and so the best I could do was the logo that's currently branded on this
blog. I still think it looks a bit "amateur-ish" (well, it _was_ done by an
amateur), but I like it because _I_ created it, and I'm a little proud of it
since it was produced from outside my comfort zone. Call it: giving my site a
little "personality" 😉
...
I'm also planning on regularly updating this blog, from changing the design to
adding more features. Most of these updates will definitely be worth writing,
so stay tuned!
